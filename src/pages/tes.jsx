...
const Tes = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
      ...
      {/* Main Card */}
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-[550px] rounded-[10px] overflow-hidden bg-cover bg-center flex  "
        style={{ backgroundImage: "url('/img/Bg-auth.avif')" }}
      >
        {/* Left Side Content */}
        <div className="relative z-10 w-1/2 h-full flex flex-col justify-between p-10 text-black">
          <div>
        ...
        <div className="relative w-1/2 h-full overflow-hidden backdrop-blur-xs">
          {/* LOGIN FORM */}
          <div
